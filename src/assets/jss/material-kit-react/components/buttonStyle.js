...
const buttonStyle = {
  ...
  primary: {
    ...
    boxShadow:
      "0 2px 2px 0 rgba(1, 88, 113, 0.14), 0 3px 1px -2px rgba(1, 88, 113, 0.2), 0 1px 5px 0 rgba(1, 88, 113, 0.12)",
    "&:hover,&:focus": {
      backgroundColor: primaryColor,
      boxShadow:
        "0 14px 26px -12px rgba(1, 88, 113, 0.42), 0 4px 23px 0px rgba(0, 0, 0, 0.12), 0 8px 10px -5px rgba(1, 88, 113, 0.2)"
    }
  },
  info: {
  ...
  instagram: {
    ...
    color: "#fff",
    boxShadow:
      "0 2px 2px 0 rgba(214,41,118, 0.14), 0 3px 1px -2px rgba(214,41,118, 0.2), 0 1px 5px 0 rgba(214,41,118, 0.12)",
    "&:hover,&:focus": {
      backgroundColor: "#d62976",
      color: "#fff",
      boxShadow:
        "0 14px 26px -12px rgba(214,41,118, 0.42), 0 4px 23px 0px rgba(214,41,118, 0.12), 0 8px 10px -5px rgba(214,41,118, 0.2)"
    }
  },
  youtube: {
