...
export default function Header(props) {
  ...
  const brandComponent = <Button href="https://fabianocorrea.com/" className={classes.headerLogo}>{brand}</Button>;
  return (
    <AppBar className={appBarClasses}>
      ...
      <Button  onClick={() => { handleScrollDown() }} justicon="true" round="true" className={classes.scrollDownBtn}>
        <ExpandMoreIcon />
      </Button>
    </AppBar>
  );
